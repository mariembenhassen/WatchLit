...
import { ArrowLeft, Eye, EyeOffIcon, Lock, Mail, User } from "lucide-react";
      ...
      <div className={signUpStyles.formContainer}>
        <div className={signUpStyles.card}>
          ...
          <p className={signUpStyles.subtitle}>
            Simple Signup to get you started
          </p>
            ...
            <div className={signUpStyles.form}>
              ...
              <div className={signUpStyles.inputContainer}>
                <div className={signUpStyles.inputIconContainer}>
                  <User className={signUpStyles.inputIcon}></User>
                </div>
                <input
                  type="text"
              ...
              <div className={signUpStyles.inputContainer}>
                <div className={signUpStyles.inputIconContainer}>
                  <Mail className={signUpStyles.inputIcon}></Mail>
                </div>
                <input
                  type="email"
                  className={signUpStyles.inputField}
                  placeholder="your@exemple.com"
                  value={email}
              ...
              <div className={signUpStyles.inputContainer}>
                ...
                >
                  {showPassword ? (
                    <EyeOffIcon className={signUpStyles.passwordToggleIcon} />
                  ) : (
