...
import { ArrowLeft, Eye, EyeOffIcon, Lock, User } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className={loginPageStyles.mainContent}>
        ...
        >
          <ArrowLeft className={`h-5 w-5 text-gray-800`}></ArrowLeft>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className={loginPageStyles.formField}>
              ...
              <div className={loginPageStyles.inputContainer}>
                <div className={loginPageStyles.inputIconContainer}>
                  <User className={loginPageStyles.inputIcon}></User>
                </div>
                <input
                  type="email"
                  id="email"
            ...
            <div className={loginPageStyles.formField}>
              ...
              <div className={loginPageStyles.inputContainer}>
                ...
                >
                  {showPassword ? (
                    <EyeOffIcon className={loginPageStyles.inputIcon} />
                  ) : (
